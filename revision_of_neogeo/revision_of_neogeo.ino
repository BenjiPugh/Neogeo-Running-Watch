...
long buttonHoldDelay1 = 750;      // how long to hold the button down for mode change
...
void loop() // run over and over again
{
  ...
  if ((millis() - gpsTimer > 60000) && (start == true)) {
       ...
       if (GPS.fix) {
        ...
        if (distHelper < 1)
        {
          ...
          if (sixteenthKm > 16)
            ...
            if (KmPixel != topLED){
              strip.setPixelColor(KmPixel, strip.Color(150,0,0));
